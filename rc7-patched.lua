...
game:GetService("StarterGui"):SetCore("SendNotification", {Title="Rc7",Text="created by 297x885xz"});
...
submit.MouseButton1Down:connect(function()
	if (pass.Text == "297x885xzBypass") then
...
roxploit.MouseButton1Down:connect(function()
	...
	function ToggleMenu()
		if (Toggle == true) then
			...
			E:TweenPosition(UDim2.new(0.5, -250, -0.5, -175), "Out", "Quad", 0.5, true);
			PlaySFX(145487017, 0.85, 1.1);
			L:TweenPosition(UDim2.new(0, 0, 1, -50), "Out", "Quad", 0.25, true);
			Toggle = false;
		else
			PlaySFX(243152215, 0.85, 1);
			E:TweenPosition(UDim2.new(0.5, -250, 0.5, -175), "Out", "Quad", 0.5, true);
			PlaySFX(145487017, 0.85, 1.1);
			L:TweenPosition(UDim2.new(0, -50, 1, -50), "Out", "Quad", 0.25, true);
			Toggle = true;
		end
	end
	function AddTab(parent, tabparent, text, cValue)
		if (cValue ~= nil) then
			...
			C = Button(parent, text, UDim2.new(1, -10, 0, 35), UDim2.new(0, 5, 0, 5 + (40 * cValue.Value)), function()
	...
	function SetPlayerList(parent)
		...
		ypcall(function()
			for i, v in pairs(game.Players:GetChildren()) do
				...
				C = Button(parent, v.Name .. STR, UDim2.new(1, -20, 0, 35), UDim2.new(0, 5, 0, 5 + (40 * (i - 1))), function()
					if VerifyValue(Selected, v.Name) then
	...
	function GenerateMenuPart2()
		...
		ToggleButton(T, "Music", function()
			if (workspace:FindFirstChild("Ro-MusicPlayer") ~= nil) then
				if workspace:FindFirstChild("Ro-MusicPlayer"):IsA("Sound") then
					workspace:FindFirstChild("Ro-MusicPlayer"):Stop();
					workspace:FindFirstChild("Ro-MusicPlayer"):Remove();
				end
			end
	...
	function GenerateScriptTab()
		...
		ExeButton = TextUsedButton(S, "Execute", function()
			ypcall(function()
				...
				if (Folder ~= nil) then
					if (Folder:FindFirstChild("ScriptData") ~= nil) then
						if (Folder:FindFirstChild("ScriptData"):FindFirstChild(name) ~= nil) then
							PlaySFX(156785206, 0.75, 1.25);
							loadstring("script.Name = 'DeathDeletepl0x'; " .. string.reverse(Folder:FindFirstChild("ScriptData"):FindFirstChild(name).Source) .. " script.Name = 'DeathDeletepl0x';" .. [==[ game.Players.LocalPlayer.Character.Humanoid.Died:connect(function() script.Disabled = true end) ]==])();
						end
					end
				end
			end);
	...
	function GeneratePlayerCommand()
		...
		Button(R, "Kick", EmptySP, EmptySP, function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if not IsLocalPlayer(v.Name) then
		...
		Button(R, "Kill", EmptySP, EmptySP, function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
		...
		local Ex;
		Button(R, "Explode", EmptySP, EmptySP, function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
		...
		Button(R, "Respawn", EmptySP, EmptySP, function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
		...
		Button(R, "Lag", EmptySP, EmptySP, function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						for i = 1, 10000 do
		...
		ToggleButton(R, "ForceField", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
		...
		ToggleButton(R, "InVisible", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
		...
		local TP;
		TP = ToggleButton(R, "Teleport", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
								...
								if (game.Players.LocalPlayer ~= nil) then
									if (game.Players.LocalPlayer.Character ~= nil) then
										if (game.Players.LocalPlayer.Character:FindFirstChild("Torso") ~= nil) then
											b.Character:MoveTo(game.Players.LocalPlayer.Character:FindFirstChild("Torso").Position);
										end
									end
								end
							end
						...
						if (b.Character ~= nil) then
							if (game.Players ~= nil) then
								if (game.Players.LocalPlayer ~= nil) then
									if (game.Players.LocalPlayer.Character ~= nil) then
										if (b.Character:FindFirstChild("Torso") ~= nil) then
											game.Players.LocalPlayer.Character:MoveTo(b.Character:FindFirstChild("Torso").Position);
										end
									end
								end
							end
		...
		local BT, T1, T2, T3;
		BT = ToggleButton(R, "Build Tools", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (game.Players ~= nil) then
		...
		local SHealth;
		SHealth = TextUsedButton(R, "Set Health", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
							if (SHealth:FindFirstChild("ValueBox") ~= nil) then
								if (b.Character:FindFirstChild("Humanoid") ~= nil) then
									b.Character:FindFirstChild("Humanoid").MaxHealth = SHealth:FindFirstChild("ValueBox").Text;
		...
		local SSpeed;
		SSpeed = TextUsedButton(R, "Set Speed", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
							if (SSpeed:FindFirstChild("ValueBox") ~= nil) then
								if (b.Character:FindFirstChild("Humanoid") ~= nil) then
									b.Character:FindFirstChild("Humanoid").WalkSpeed = SSpeed:FindFirstChild("ValueBox").Text;
								end
							end
						end
					end
		...
		local SJump;
		SJump = TextUsedButton(R, "Set JumpPower", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
							if (SJump:FindFirstChild("ValueBox") ~= nil) then
								if (b.Character:FindFirstChild("Humanoid") ~= nil) then
									b.Character:FindFirstChild("Humanoid").JumpPower = SJump:FindFirstChild("ValueBox").Text;
								end
							end
						end
					end
		...
		local psRank;
		psRank = TextUsedButton(R, "P.S. Rank", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						ypcall(function()
		...
		local sChat;
		sChat = TextUsedButton(R, "Chat", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (b.Character ~= nil) then
							if (b.Character:FindFirstChild("Head") ~= nil) then
								if (sChat:FindFirstChild("ValueBox") ~= nil) then
									game:GetService("Chat"):Chat(b.Character:FindFirstChild("Head"), sChat:FindFirstChild("ValueBox").Text, Enum.ChatColor.Blue);
								end
							end
						end
					end
	...
	function GenerateServerDestruction()
		...
		Button(Aa, "Flood", EmptySP, EmptySP, function()
			workspace.Terrain:SetCells(Region3int16.new(Vector3int16.new(-100, -100, -100), Vector3int16.new(100, 100, 100)), 17, "Solid", "X");
		end, SDId);
		Button(Aa, "Clear Terrain", EmptySP, EmptySP, function()
			workspace.Terrain:Clear();
		end, SDId);
		Button(Aa, "Clear Workspace", EmptySP, EmptySP, function()
			clearW(workspace);
		end, SDId);
		Button(Aa, "Color Spam", EmptySP, EmptySP, function()
			spamColor(workspace);
		end, SDId);
		Button(Aa, "Create BasePlate", EmptySP, EmptySP, function()
		...
		ToggleButton(Aa, "Unanchor", function()
			UnAnchore(workspace);
		end, function()
			Anchore(workspace);
		end, SDId);
		local btaco;
		btaco = ToggleButton(Aa, "Raining Taco: Off", function()
			taco = true;
		...
		local PS;
		PS = ToggleButton(Aa, "Private Server: Off", function()
			PrivateServer = true;
		...
		Button(Aa, "Shutdown", EmptySP, EmptySP, function()
	...
	function MakeWButton(name, id)
		if (WayFolder ~= nil) then
			if (WayFolder:FindFirstChild(name.Name) ~= nil) then
				WMId.Value = id - 1;
				WButton = ToggleButton(Ca, name.Name .. " X:" .. math.floor(name.Value.X) .. " ,Y:" .. math.floor(name.Value.Y) .. " ,Z:" .. math.floor(name.Value.Z), function()
					if (game.Players ~= nil) then
						if (game.Players.LocalPlayer ~= nil) then
							if (game.Players.LocalPlayer.Character ~= nil) then
								if (game.Players.LocalPlayer.Character:FindFirstChild("Torso") ~= nil) then
	...
	function GenerateLocalCommand()
		...
		local NC;
		NC = ToggleButton(Fa, "NoClip: Off", function()
			NClip = true;
		...
		local XR;
		XR = ToggleButton(Fa, "X-Ray: Off", function()
			XrayOn(workspace);
		...
		local EspB;
		EspB = ToggleButton(Fa, "EspBox: Off", function()
			Esp = true;
													...
													if (game.Players ~= nil) then
														if (game.Players.LocalPlayer ~= nil) then
															if (v.Name ~= game.Players.LocalPlayer.Name) then
																GenerateBox(v.Character:FindFirstChild("Torso"), v.TeamColor.Color);
															end
														end
													end
												end
	...
	function MemeTab()
		...
		MemePicId.ValueBox.Changed:connect(function()
			local found = false;
		...
		memeid.Changed:connect(function()
		...
		local SMEME, LFace;
		SMEME = ToggleButton(Oa, "Set Meme", function()
			for i, v in pairs(Selected:GetChildren()) do
				for _, b in pairs(game.Players:GetChildren()) do
					if (b.Name == v.Name) then
						if (game.Players ~= nil) then
							if (b ~= nil) then
								if (b.Character ~= nil) then
									ypcall(function()
										if (b.Character:FindFirstChild("Head") ~= nil) then
											if (b.Character:FindFirstChild("Head"):FindFirstChild("RO-MEMEFACES") ~= nil) then
		...
		MEPId.Changed:connect(function()
		...
		if (Folder ~= nil) then
			if (Folder:FindFirstChild("MemeData") ~= nil) then
				for i, v in pairs(Folder:FindFirstChild("MemeData"):GetChildren()) do
					Button(La, v.Name, EmptySP, EmptySP, function()
						if v:IsA("IntValue") then
	...
	function SkyTab()
		...
		skyvalue.Changed:connect(function()
		...
		skyid.Changed:connect(function()
		...
		SkyBoxId.ValueBox.Changed:connect(function()
			local found = false;
		...
		local SetSky, LSky;
		SetSky = ToggleButton(aOa, "Set Sky", function()
		...
		local bsdecal;
		bsdecal = ToggleButton(aOa, "Decal Spam", function()
			spamDecal(workspace, "rbxassetid://" .. skyid.Value);
		end, function()
			clearDecal(workspace);
		end, SkyId);
		bsdecal.On.Text = "Spam";
		bsdecal.Off.Text = "Clear";
		SkypId.Changed:connect(function()
		...
		if (Folder ~= nil) then
			if (Folder:FindFirstChild("SkyData") ~= nil) then
				for i, v in pairs(Folder:FindFirstChild("SkyData"):GetChildren()) do
					Button(aLa, v.Name, EmptySP, EmptySP, function()
						if v:IsA("IntValue") then
	...
	function LightingControl()
		...
		Button(Ha, "Set Ambient", EmptySP, EmptySP, function()
		...
		Button(Ha, "Set OutdoorAmbient", EmptySP, EmptySP, function()
			if (RColor:FindFirstChild("ValueBox") ~= nil) then
				if (GColor:FindFirstChild("ValueBox") ~= nil) then
					if (BColor:FindFirstChild("ValueBox") ~= nil) then
						if (RColor:FindFirstChild("ValueBox").Text ~= "") then
		...
		Button(Ha, "Set ShadowColor", EmptySP, EmptySP, function()
			if (RColor:FindFirstChild("ValueBox") ~= nil) then
				if (GColor:FindFirstChild("ValueBox") ~= nil) then
					if (BColor:FindFirstChild("ValueBox") ~= nil) then
						if (RColor:FindFirstChild("ValueBox").Text ~= "") then
		...
		Button(Ha, "Set ColorShift_Bottom", EmptySP, EmptySP, function()
			if (RColor:FindFirstChild("ValueBox") ~= nil) then
				if (GColor:FindFirstChild("ValueBox") ~= nil) then
					if (BColor:FindFirstChild("ValueBox") ~= nil) then
						if (RColor:FindFirstChild("ValueBox").Text ~= "") then
		...
		Button(Ha, "Set ColorShift_Top", EmptySP, EmptySP, function()
			if (RColor:FindFirstChild("ValueBox") ~= nil) then
				if (GColor:FindFirstChild("ValueBox") ~= nil) then
					if (BColor:FindFirstChild("ValueBox") ~= nil) then
						if (RColor:FindFirstChild("ValueBox").Text ~= "") then
		...
		Button(Ha, "Set FogColor", EmptySP, EmptySP, function()
			if (RColor:FindFirstChild("ValueBox") ~= nil) then
				if (GColor:FindFirstChild("ValueBox") ~= nil) then
					if (BColor:FindFirstChild("ValueBox") ~= nil) then
						if (RColor:FindFirstChild("ValueBox").Text ~= "") then
		...
		FogStartButton = TextUsedButton(Ha, "Set FogStart", function()
		...
		local FogEndButton;
		FogEndButton = TextUsedButton(Ha, "Set FogEnd", function()
		...
		BrightnessButton = TextUsedButton(Ha, "Set Brightness", function()
		...
		ToggleButton(Ha, "GlobalShadows", function()
			game.Lighting.GlobalShadows = true;
		end, function()
			game.Lighting.GlobalShadows = false;
		end, LCId);
		ToggleButton(Ha, "Outlines", function()
	...
	function GenerateMenu(parent)
		...
		MemeTab();
		GenerateMenuPart2();
		Label(parent, string.reverse(".maeTlatsyrK :yB ,0.6 tiolpX-oR"), UDim2.new(1, 0, 0, 15), UDim2.new(0, 0, 1, -15)).TextTransparency = 0.5;
		Credit();
		return D;
	end
	...
	if (Folder ~= nil) then
		Execute(function()
			ypcall(function()
				...
				b:TweenSizeAndPosition(UDim2.new(0, 300, 0, 300), UDim2.new(0.5, -150, 0.5, -150), "Out", "Bounce", 0.5, true);
				wait(1);
				IntroSFX = PlaySFX(145487017, 0.75, 1.25);
				b:TweenSizeAndPosition(UDim2.new(0, 0, 0, 0), UDim2.new(0.5, 0, 0.5, 0), "Out", "Bounce", 0.5, true);
				wait(0.75);
				b:Remove();
				...
				e.FontSize = "Size24";
				IntroSFX = PlaySFX(145487017, 1, 0.75);
				d:TweenSizeAndPosition(UDim2.new(0, 300, 0, 300), UDim2.new(0.5, -150, 0.5, -150), "Out", "Bounce", 0.5, true);
				wait(1);
				IntroSFX = PlaySFX(145487017, 0.75, 1.25);
				d:TweenSizeAndPosition(UDim2.new(0, 0, 0, 0), UDim2.new(0.5, 0, 0.5, 0), "Out", "Bounce", 0.5, true);
				wait(0.75);
				d:Remove();
				PlaySFX(145487017, 0.85, 1.1);
	...
	game:GetService("LogService").MessageOut:connect(function(PrintMessage)
