--[[
	!! I DID NOT MAKE FATES ADMIN, THIS IS ONLY A FIXED VERSION FOR KRNL !!
	Fates Admin Fixed is made by C5Hax
	The original version of Fates Admin is not made by C5Hax
]]

warn("!! I DID NOT MAKE FATES ADMIN, THIS IS ONLY A FIXED VERSION FOR KRNL !!")
warn("Fates Admin Fixed is made by C5Hax")
warn("The original version of Fates Admin is not made by C5Hax")
